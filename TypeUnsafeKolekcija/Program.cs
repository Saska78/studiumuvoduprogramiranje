...
namespace TypeUnsafeKolekcija
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Broj elementa liste: "+lista.Count);
            ...
            //list.Sort();//radi samo kad su u listi usporedivi podaktovni tipovi!
            foreach (var item in lista)
            {
                Console.WriteLine(item);
            }

            Console.WriteLine("Kapcitet liste: " + lista.Capacity);
