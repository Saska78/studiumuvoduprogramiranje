 ...
 * Mogu biti logovi,upute ili nesto slicno
...

{
    ...
    internal class Program
    {
        ...
        /// sturi opis metode
        /// </summary>
        /// <param name="args">Parametar koji se inace predaje preko komzolepozivom</param>
        static void Main(string[] args)
        {
            //linijski komentar
            Console.WriteLine("Pozdrav svima :)");//nacin ispisa poruke na konzoli
            ...
            //Console.ReadLine();//Ceka pritisak entera za kraj programa
