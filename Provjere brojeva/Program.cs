...
namespace Provjere_brojeva
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            if (Savrsen(broj)) Console.WriteLine("Broj je savrsen");
            if (FibbonacchijevBroj(broj)) Console.WriteLine("Broj je dio Fibbonaccijevog niza");
            ...
            for(int i = 1; i < 100; i++)
            {
                ...
                if (Savrsen(i)) Console.WriteLine("Broj je savrsen");
                if (FibbonacchijevBroj(i)) Console.WriteLine("Broj je dio Fibbonaccijevog niza");
            }
